...
# Definición del equipo gw
  config.vm.define "gw" do |gw|
    ...
    gw.vm.network "private_network", ip: "172.3.#{N}.1", netmask: "255.255.255.0", virtualbox__intnet: "red_gestión"
  ...
  config.vm.define "idp" do |idp|
    ...
    idp.vm.network "private_network", ip: "172.3.#{N}.2", netmask: "255.255.255.0", virtualbox__intnet: "red_gestión"
